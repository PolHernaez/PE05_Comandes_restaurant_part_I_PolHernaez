...
public class PE05 {
    ...
    boolean menuA = true;
    String linea = "", nomProducte = "", nomClient = "", resposta = "";
    int numeroTicket = 1, espaiTicket = 0, quantitat = 0;
    double preuUnitari = 0, total = 0;
    ...
    public void comandaGuardadaM(String nomClient, String linea, double total) { // Guardar comanda completa
        comandaGuardada = comandaGuardada + "\n" + "TICKET" + "\n" + "Client: " + nomClient + "\n" + "============================================================================" + "\n" + "NÚM\tPRODUCTE            PREU UNITARI        QUANTITAT          SUBTOTAL" + "\n" + linea + "============================================================================" + "\n" + "TOTAL SENSE IVA: " + igualarTicket(total + "€", 59) + total + "€" + "\n" + "IVA (10%): " + igualarTicket((total * 0.1) + "€", 65) + (total * 0.1) + "€" + "\n" + "TOTAL: " + igualarTicket((total + (total * 0.1)) + "€",  69) + (total + (total * 0.1)) + "€" + "\n" + "============================================================================";
    }
